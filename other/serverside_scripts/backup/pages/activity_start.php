...
<div data-role="page" id="app_login" data-theme="e">
    ...
    <div data-role="content" data-theme="e">    
       ...
       <a href="activity_questions.php?activity_id=<?= $activity_id; ?>&assessment_id=<?= $assessment_id;?>&total_rows=<?= $total_rows; ?>
       &start_row=0" data-role="button" data-inline="true" data-theme="e" data-mini="true">Start</a>
   	</div>
